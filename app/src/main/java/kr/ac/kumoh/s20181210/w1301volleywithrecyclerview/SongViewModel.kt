package kr.ac.kumoh.s20181210.w1301volleywithrecyclerview
...
class SongViewModel(application: Application): AndroidViewModel(application) {
    ...
    val list: LiveData<ArrayList<Song>>get() = _list
    ...
    fun requestSong() {
        val url = "https://expresssongdb-ehwlx.run.goorm.io/song"
